...
def main():
    ...
    div_nodes = driver.find_elements_by_css_selector('div.KPJpj:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1)')

    print(f"Length: {len(div_nodes)}")
    # for i in range(len(div_nodes)):
    #     print(div_nodes[i].find_element_by_xpath('//div/div/div[2]/div/div/span').text)
    # for i in div_nodes:
    #     try:
    #         print(i)
    #         i.find_element_by_xpath('//div/div/div[2]/div/div/span').text
    #     except Exception as e:
    #         print("Not found, moving to next element")
    #         pass
    input()
